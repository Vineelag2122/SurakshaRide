...
3. App Outage During Peak Time

- During peak dinner hours, the delivery app stops working for some time. Suresh is online and ready, but no orders are assigned due to the outage. He loses valuable earning time.
- SurakshaRide detects the platform downtime and automatically credits compensation for the lost opportunity
